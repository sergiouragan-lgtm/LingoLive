...
export const COUNTRY_DETAILS: Record<string, CountryDetail> = {
  CV: {
    ...
    slangs: [],
    holidays: [
      { date: '07-05', name: 'Dia da Independência', description: 'Independência de Cabo Verde de Portugal em 1975.' },
    ],
    themes: [],
  },
  GW: {
    ...
    currency: 'Franco CFA da África Ocidental',
    symbol: 'CFA',
    dateFormat: 'DD/MM/YYYY',
    slangs: [],
    holidays: [
      { date: '09-24', name: 'Dia da Independência', description: 'Independência da Guiné-Bissau de Portugal em 1973.' },
    ],
    themes: [],
  },
  ST: {
    ...
    slangs: [],
    holidays: [
      { date: '07-12', name: 'Dia da Independência', description: 'Independência de São Tomé e Príncipe de Portugal em 1975.' },
    ],
    themes: [],
  },
  TL: {
    ...
    slangs: [],
    holidays: [
      { date: '05-20', name: 'Dia da Restauração da Independência', description: 'Restauração da independência de Timor-Leste em 2002.' },
    ],
    themes: [],
  },
  NG: {
    ...
    slangs: [],
    holidays: [
      { date: '10-01', name: 'Independence Day', description: "Nigeria's independence from the United Kingdom in 1960." },
    ],
    themes: [],
  },
  GB: {
    ...
    slangs: [],
    holidays: [
      { date: '12-26', name: 'Boxing Day', description: 'Traditional public holiday the day after Christmas.' },
    ],
    themes: [],
  },
  DE: {
    ...
    slangs: [],
    holidays: [
      { date: '10-03', name: 'Tag der Deutschen Einheit', description: 'Dia da Unidade Alemã, comemora a reunificação em 1990.' },
    ],
    themes: [],
  },
  IT: {
    ...
    slangs: [],
    holidays: [
      { date: '06-02', name: 'Festa della Repubblica', description: 'Comemora a fundação da República Italiana em 1946.' },
    ],
    themes: [],
  },
  CN: {
    ...
    name: 'China',
    flag: '🇨🇳',
    language: '普通话 (Mandarim)',
    currency: 'Renminbi (Yuan)',
    symbol: '¥',
    dateFormat: 'YYYY-MM-DD',
    slangs: [],
    holidays: [
      { date: '10-01', name: 'Dia Nacional', description: 'Comemora a fundação da República Popular da China em 1949.' },
    ],
    themes: [],
  },
  IN: {
    ...
    slangs: [],
    holidays: [
      { date: '08-15', name: 'Independence Day', description: "India's independence from British rule in 1947." },
    ],
    themes: [],
  },
  BR: {

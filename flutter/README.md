...
2. Executar `flutter create --platforms=android,ios --org com.lingolive --project-name ai .` nesta pasta para materializar/atualizar os shells nativos com o identificador `com.lingolive.ai`, se ainda não existirem. O CI executa este passo automaticamente.

...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      setState(() => _error = switch (error.code) {
            ...
            'weak-password' =>
              'Use uma palavra-passe com pelo menos 8 caracteres.',
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      ...
      if (mounted)
        setState(() => _error = 'Não foi possível enviar a recuperação.');
    } finally {
      if (mounted) setState(() => _busy = false);
    }
  }
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        _register
                            ? 'Crie a sua conta de aprendizagem'
                            : 'Continue o seu percurso',
                        textAlign: TextAlign.center),
                    ...
                    TextButton(
                        ...
                        child: Text(
                            _register ? 'Já tenho conta' : 'Criar uma conta')),
                    if (!_register)
                      TextButton(

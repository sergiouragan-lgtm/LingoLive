...
describe('resolveRegionalLanguageProfile', () => {
  it('prefers and normalizes an explicit variant', () => expect(resolveRegionalLanguageProfile({ selectedLanguage: 'pt', country: 'AO', explicitVariant: 'PT_br' }).variant).toBe('pt-BR'));
